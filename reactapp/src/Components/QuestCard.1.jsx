export function QuestCard() {
    (co2kilograms) => {
        const co2 = co2kilograms > 999.99999
            ? `${(Math.round(co2kilograms / 1000 * 100) / 100).toFixed(1)} t CO₂e`
            : `${(Math.round(co2kilograms * 100) / 100).toFixed(0)} kg CO₂e`;
        return (
            <li>{co2}</li>
            //<Center as='section' bg='#ededef' h='55vh'>
            ...
            //                    {`${numcountries} countries, ${days} days`}
            //                </Text>
            //            </Center>
            //            <Center >
            //                <Button my='8' background='#4066bd' color='white' fontWeight='normal'
            //                    fontSize='small' size='sm' borderRadius='3'>Learn more</Button>
            //            </Center>
            //            <Center my='5'>
